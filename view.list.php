...
<tr>
	...
	<td>
        ...
        <a href="view.php?table=<? echo trim($_GET['table']) ?>&page=<? echo $page ?>&search=<? echo urlencode($_GET['search']) ?>&idx=<? echo $qb_idx ?>"><? echo ($_GET['idx'] == $qb_idx) ? "<strong>".$qb_subject."</strong>" : $qb_subject ?></a>&nbsp;<? echo comment_cnt($qb_idx) ?>&nbsp;<? echo get_date_new($row['qb_date']) ?>
    </td>
